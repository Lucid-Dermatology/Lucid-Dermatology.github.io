...
When a user selects **Fragrance Mix**, our algorithm recognizes products as **UNSAFE** if the product has at least one of the following ingredients or at least one synonym of following chemicals. (You can see list of synonyms for each chemical by clicking on allergen name)
